...
def main():
    ...
    # This will come from the user Prompt containing the {variable}
    summary_template = """
    given the information {bio} about a person I want to create:
    1. A Short Summary
    2. Two interesting fact about them
    """

    # summary_prompt_template = PromptTemplate(
    #     input_variables=["bio"], template=summary_template
    # )
